...
Then we used some visualizations to better understand these 195 rules. We drawed the scatter plot to visulize the relationship among support, confidence and lift. 
```{r}
